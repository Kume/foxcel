...
type AnyDataPath = ForwardDataPath | DataPath | MultiDataPath | EditingForwardDataPath;
...
export function dataPathComponentIsReverse(component: AnyDataPathComponent): component is ReversePathComponent {
