...
function peg$parse(input, options) {
  ...
  var peg$e4 = peg$literalExpectation("$key", false);
  ...
  function peg$parseGeneralPathComponent() {
    ...
    s0 = peg$parseWildWord();
    if (s0 === peg$FAILED) {
      s0 = peg$parseWord();
      if (s0 === peg$FAILED) {
        s0 = peg$parsePathVariable();
      }
    }
